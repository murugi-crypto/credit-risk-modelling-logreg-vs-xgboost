...
- Logistic Regression slightly better at detecting defaulters
- XGBoost slightly better at protecting good clients
- Model performance is highly sensitive to threshold selection
